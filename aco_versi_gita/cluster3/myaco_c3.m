%**************************************************************************
%                 VRP Problem Using ACO cluster 3
% -------------------------------------------------------------------------
...
% matrix coordinates of cities cluster 3
map_index=[10	11	14	15	19	28];
map_x=[10.56	10.06	9.88	9.48	8.75	8.86];
map_y=[2.51	2.36	2.06	2.18	1.92	0.84];
...
%    end
%end
d=[0 2.9 3.4 3.4 4.6 5.7;
   2.9 0 0.6 0.6 1.7 3;
   3.4 0.6 0 0.55 2.6 2.4;
   3.4 0.6 0.55 0 0.75 2.3;
   4.6 1.7 2.6 0.75 0 5.7;
   5.7 3 2.4 2.3 5.7 0];
