%**************************************************************************
%                 VRP Problem Using ACO cluster 1
% -------------------------------------------------------------------------
...
% matrix coordinates of cities cluster 1
map_index =[1	2	3	4	8	9];
map_x=[11.95	13.08	12.39	11.57	10.31	10.22];
map_y=[3.00	3.86	3.66	3.30	3.59	4.10];
...
%    end
%end
% Input distance matrix between node
d=[0 1.8 1.1 0.7 2.1 2.7;
1.8	0 1.2 2.3 3.8 3.4;
1.1	1.2	0 1.5 2.4 3;
0.7	2.3	1.5	0 1.5 2.2;
2.1	3.8	2.4	1.5	0 0.9;
2.7	3.4	3 2.2 0.9 0];
