%**************************************************************************
%                 VRP Problem Using ACO cluster 6
% -------------------------------------------------------------------------
...
% matrix coordinates of cities cluster 6
map_index=[23	30	33	40	53	64	67];
map_x=[7.92	7.50	7.18	6.56	4.80	7.24	5.55];
map_y=[4.45	5.09	4.79	5.49	5.24	6.92	7.29];
...
%    end
%end
d=[0 1.2 1 2.4 4.1 4.8 6;
   1.2 0 0.75 2.5 3.5 4.7 6;
   1 0.75 0 2.3 3.3	4.5	5.8;
   2.4 2.5 2.3 0 3.8 2.3 6.3;
   4.1 3.5 3.3 3.8 0 5.8 3.6;
   4.8 4.7 4.5 2.3 5.8 0 9.5;
   6 6 5.8 6.3 3.6 9.5 0];
