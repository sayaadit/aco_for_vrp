%**************************************************************************
%                 VRP Problem Using ACO cluster 5
% -------------------------------------------------------------------------
...
% matrix coordinates of cities cluster 5
map_index=[22	25	26	27	29	39	47];
map_x=[7.15	7.19	6.55	7.64	6.45	6.04	6.56];
map_y=[3.51	3.76	3.40	2.98	3.73	4.56	4.25];
...
%    end
%end
d=[0 0.5 1.5 1.3 1.1 2.8 1.6;
   0.5 0 1.4 0.95 1.5 3.1 2.2;
   1.5 1.4 0 1.5 0.5 2 1.3;
   1.3 0.95 1.5 0 2 3.5 2.7;
   1.1 1.5 0.5 2 0 1.5 0.7;
   2.8 3.1 2 3.5 1.5 0 0.8;
   1.6 2.2 1.3 2.7 0.7 0.8 0];
