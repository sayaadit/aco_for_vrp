%**************************************************************************
%                 VRP Problem Using ACO cluster 10
% -------------------------------------------------------------------------
...
% matrix coordinates of cities cluster 10
map_index=[52	54	55	56	63	66	68];
map_x=[3.53	4.82	4.75	5.15	4.68	4.04	3.59];
map_y=[5.05	5.88	5.88	5.89	6.37	5.55	6.06];
...
%    end
%end
d=[0 2.3 2.3 2.6 2.7 1.2 2.4;
   2.3 0 0.1 0.35 0.95 1.3 1.2;
   2.3 0.1 0 0.45 1 1 1.2;
   2.6 0.35 0.45 0 1.1 1.7 1.6;
   2.7 0.95 1 1.1 0 1.6 1.4;
   1.2 1.3 1 1.7 1.6 0 1.2;
   2.4 1.2 1.2 1.6 1.4 1.2 0];
