%**************************************************************************
%                 VRP Problem Using ACO cluster 2
% -------------------------------------------------------------------------
...
% matrix coordinates of cities cluster 2
map_index=[5	6	7	12	17	18];
map_x=[12.75	13.53	13.26	11.60	12.86	11.34];
map_y=[2.25	2.42	2.04	1.34	1.51	0.53];
...
%    end
%end
d=[0 1 0.6 2.8 3.4 4.2;
   1 0 1 3.9 3.7 5.3;
   0.6 1 0 3.4 2.8 4.8;
   2.8 3.9 3.4 0 3.6 1.4;
   3.4 3.7 2.8 3.6 0 5.4;
   4.2 5.3 4.8 1.4 5.4 0];
