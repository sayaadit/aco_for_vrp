%**************************************************************************
%                 VRP Problem Using ACO cluster 7
% -------------------------------------------------------------------------
...
% matrix coordinates of cities cluster 7
map_index=[35	36	41	43	44	48];
map_x=[6.01	7.17	4.66	5.08	6.96	4.20];
map_y=[1.88	1.26	2.96	2.13	0.10	1.72];
...
%end
d=[0 2.2 2.6 1 3.6 2;
   2.2 0 4.9 3.7 2.4 3.9;
   2.6 4.9 0 4.6 7.4 3.8;
   1 3.7 4.6 0 4.5 2.8;
   3.6 2.4 7.4 4.5 0 4.2;
   2 3.9 3.8 2.8 4.2 0];
